...
'<li style="width:144px;background:#FFF;padding-bottom:1px;" id="SelectArea"><div id="sYear" onclick="ShowSelect(\'SelectYear\',\'Y\');">'+year+'</div><div id="SArr" onclick="ShowSelect(\'SelectYear\',\'Y\');"><font face="Webdings">&#54;</font></div>'+
...
if(Calendar_obj2){content+='<li style="width:42px;"><a href="javascript:parent.Calendar_GetDate('+year+','+month+',0);"></a></li>'+
'<li style="width:43px;"><a href="javascript:parent.Calendar_GetDate('+date.getFullYear()+','+(date.getMonth()+1)+','+date.getDate()+');"></a></li>';}
else{content+='<li style="width:86px;"><a href="javascript:parent.Calendar_GetDate('+date.getFullYear()+','+(date.getMonth()+1)+','+date.getDate()+');">?</a></li>';}
...
'</ul></div>'+
'<div id="Title"><ul><li style="color:#F00;"></li><li>?</li><li></li><li></li><li></li><li></li><li style="color:#F00;"></li></ul></div>'+
...
Calendar.style.height=66+21*Trn+'px';		//??
...
var dH=Calendar.style.pixelHeight;	//??
